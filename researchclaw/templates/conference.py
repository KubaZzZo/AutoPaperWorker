...
CVPR_2026 = ConferenceTemplate(
    name="cvpr_2026",
    display_name="CVPR 2026",
    year=2026,
    document_class="article",
    style_package="cvpr",
    style_options="review",
    extra_packages=(
        "times",
        "epsfig",
        "graphicx",
    ...
    author_format="neurips",
    bib_style="ieeenat_fullname",
    columns=2,
    style_download_url="https://cvpr.thecvf.com/Conferences/2026/AuthorGuidelines",
    preamble_extra="\\usepackage[pagebackref,breaklinks,colorlinks]{hyperref}",
)

ACL_2026 = ConferenceTemplate(
    name="acl_2026",
    ...
    columns=2,
    style_download_url="https://acl-org.github.io/ACLPUB/formatting.html",
)

AAAI_2026 = ConferenceTemplate(
    name="aaai_2026",
    ...
    bib_style="aaai2026",
    columns=2,
    style_download_url="https://aaai.org/authorkit26/",
)

KDD_2026 = ConferenceTemplate(
    name="kdd_2026",
    ...
    columns=2,
    style_download_url="https://www.acm.org/publications/proceedings-template",
    preamble_extra="\\settopmatter{printacmref=false}\n\\renewcommand\\footnotetextcopyrightpermission[1]{}",
)

NATURE = ConferenceTemplate(
    name="nature",
    display_name="Nature-style Article",
    year=2026,
    document_class="article",
    style_package="",
    style_options="",
    ...
    bib_style="naturemag",
    columns=1,
    style_download_url="https://www.nature.com/nature/for-authors/formatting-guide",
    preamble_extra="\\usepackage[margin=1in]{geometry}\n\\doublespacing\n\\linenumbers",
)

SCIENCE = ConferenceTemplate(
    name="science",
    display_name="Science-style Article",
    year=2026,
    document_class="article",
    style_package="",
    style_options="",
    ...
    bib_style="science",
    columns=1,
    style_download_url="https://www.science.org/content/page/instructions-preparing-initial-manuscript",
    preamble_extra="\\usepackage[margin=1in]{geometry}\n\\doublespacing\n\\linenumbers",
)
