...
from researchclaw.pipeline.stage_impls._execution_refine_helpers import (
    _files_to_context,
...
def _execute_iterative_refine(
    ...
    *,
    ...
    if config.experiment.mode == "simulated":
        return _handle_simulated_iterative_refine(stage_dir, run_dir, config)
    ...
    if llm is None:
        return _handle_llm_unavailable_iterative_refine(
            stage_dir, best_files, best_metric, log
        )
