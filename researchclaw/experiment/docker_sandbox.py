...
from researchclaw.experiment.docker_sandbox_helpers import (
    _BUILTIN_PACKAGES,
    _IMPORT_TO_PIP,
...
class DockerSandbox:
    ...
    def _build_run_command(
        ...
        *,
        ...
        # Pass HF token only when explicitly enabled. Experiment code is often
        # generated by an LLM, so forwarding host credentials must be opt-in.
        hf_token = os.environ.get("HF_TOKEN") or os.environ.get("HUGGING_FACE_HUB_TOKEN")
        if cfg.forward_hf_token and hf_token:
